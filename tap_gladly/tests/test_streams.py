...
from tap_gladly.streams import ExportJobsStream, ExportFileConversationItemsStream, \
...
def test_started_at():
    ...
    after_row = {'record': 'data', 'parameters': {
        'startAt': datetime.datetime.now(datetime.timezone.utc).strftime(gladlyStream._common_date_format)}
                 }
